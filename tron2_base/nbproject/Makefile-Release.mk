...
${OBJECTDIR}/src/tron2/base/Concept.o: src/tron2/base/Concept.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/base/Concept.o src/tron2/base/Concept.cpp

${OBJECTDIR}/src/tron2/base/Element.o: src/tron2/base/Element.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron2/base
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/base/Element.o src/tron2/base/Element.cpp

${OBJECTDIR}/src/tron2/base/Nature.o: src/tron2/base/Nature.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron2/base
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/base/Nature.o src/tron2/base/Nature.cpp

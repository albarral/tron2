...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libtron2_language.${CND_DLIB_EXT}: ../../tron/tron_util/dist/Debug/GNU-Linux/libtron_util.so
...
${OBJECTDIR}/src/tron2/language/objects/FiguresTheme.o: src/tron2/language/objects/FiguresTheme.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron2/language/objects
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../tron/tron_util/src -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/language/objects/FiguresTheme.o src/tron2/language/objects/FiguresTheme.cpp

...
${OBJECTDIR}/src/tron2/robot/RobotNodes.o: src/tron2/robot/RobotNodes.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/robot/RobotNodes.o src/tron2/robot/RobotNodes.cpp
...
${OBJECTDIR}/src/tron2/robot/topics/ArmTopics.o: src/tron2/robot/topics/ArmTopics.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/robot/topics/ArmTopics.o src/tron2/robot/topics/ArmTopics.cpp

${OBJECTDIR}/src/tron2/robot/topics/BodyTopics.o: src/tron2/robot/topics/BodyTopics.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron2/robot/topics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/robot/topics/BodyTopics.o src/tron2/robot/topics/BodyTopics.cpp

...
${OBJECTDIR}/src/tron2/moves/CircularMovement.o: src/tron2/moves/CircularMovement.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/moves/CircularMovement.o src/tron2/moves/CircularMovement.cpp
...
${OBJECTDIR}/src/tron2/moves/WaveMovement.o: src/tron2/moves/WaveMovement.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron2/moves
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/moves/WaveMovement.o src/tron2/moves/WaveMovement.cpp

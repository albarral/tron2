...
${OBJECTDIR}/src/tron2/concepts/Category.o: src/tron2/concepts/Category.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/concepts/Category.o src/tron2/concepts/Category.cpp

${OBJECTDIR}/src/tron2/concepts/Concept.o: src/tron2/concepts/Concept.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tron2/concepts
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tron2/concepts/Concept.o src/tron2/concepts/Concept.cpp

...
LDLIBSOPTIONS=-llog4cxx -Wl,-rpath,../../amy/amy_interface/dist/Debug/GNU-Linux -L../../amy/amy_interface/dist/Debug/GNU-Linux -lamy_interface -Wl,-rpath,../../goon/goon_interface/dist/Debug/GNU-Linux -L../../goon/goon_interface/dist/Debug/GNU-Linux -lgoon_interface -Wl,-rpath,../../roly/roly_interface/dist/Debug/GNU-Linux -L../../roly/roly_interface/dist/Debug/GNU-Linux -lroly_interface -Wl,-rpath,../tron2_robot/dist/Debug/GNU-Linux -L../tron2_robot/dist/Debug/GNU-Linux -ltron2_robot -Wl,-rpath,../tron2_coms/dist/Debug/GNU-Linux -L../tron2_coms/dist/Debug/GNU-Linux -ltron2_coms -Wl,-rpath,../../tron/tron_util/dist/Debug/GNU-Linux -L../../tron/tron_util/dist/Debug/GNU-Linux -ltron_util -Wl,-rpath,../../tron/tron_wire/dist/Debug/GNU-Linux -L../../tron/tron_wire/dist/Debug/GNU-Linux -ltron_wire -Wl,-rpath,../../tron/tron_wire2/dist/Debug/GNU-Linux -L../../tron/tron_wire2/dist/Debug/GNU-Linux -ltron_wire2 -Wl,-rpath,../../tron/tron_tools/dist/Debug/GNU-Linux -L../../tron/tron_tools/dist/Debug/GNU-Linux -ltron_tools

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dady

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dady: ../../amy/amy_interface/dist/Debug/GNU-Linux/libamy_interface.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dady: ../../goon/goon_interface/dist/Debug/GNU-Linux/libgoon_interface.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dady: ../../roly/roly_interface/dist/Debug/GNU-Linux/libroly_interface.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dady: ../tron2_robot/dist/Debug/GNU-Linux/libtron2_robot.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dady: ../tron2_coms/dist/Debug/GNU-Linux/libtron2_coms.so
...
${OBJECTDIR}/src/dady/DadyCommander2.o: src/dady/DadyCommander2.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../amy/amy_interface/src -I../../goon/goon_interface/src -I../../roly/roly_interface/src -I../tron2_robot/src -I../tron2_coms/src -I../../tron/tron_util/src -I../../tron/tron_wire/src -I../../tron/tron_wire2/src -I../../tron/tron_tools/src -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dady/DadyCommander2.o src/dady/DadyCommander2.cpp

${OBJECTDIR}/src/dady/RobotChannels.o: src/dady/RobotChannels.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/dady
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../amy/amy_interface/src -I../../goon/goon_interface/src -I../../roly/roly_interface/src -I../tron2_robot/src -I../tron2_coms/src -I../../tron/tron_util/src -I../../tron/tron_wire/src -I../../tron/tron_wire2/src -I../../tron/tron_tools/src -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dady/RobotChannels.o src/dady/RobotChannels.cpp

${OBJECTDIR}/src/dady/main.o: src/dady/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/dady
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -I../../amy/amy_interface/src -I../../goon/goon_interface/src -I../../roly/roly_interface/src -I../tron2_robot/src -I../tron2_coms/src -I../../tron/tron_util/src -I../../tron/tron_wire/src -I../../tron/tron_wire2/src -I../../tron/tron_tools/src -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dady/main.o src/dady/main.cpp

# Subprojects
.build-subprojects:
	cd ../../amy/amy_interface && ${MAKE}  -f Makefile CONF=Debug
	cd ../../goon/goon_interface && ${MAKE}  -f Makefile CONF=Debug
...
.clean-subprojects:
	...
	cd ../../goon/goon_interface && ${MAKE}  -f Makefile CONF=Debug clean
